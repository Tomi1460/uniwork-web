import { Mail, MessageCircle, MapPin, Camera, Music } from 'lucide-react'
import './Contact.css'

const contactInfo = [
  { Icon: Mail, label: 'Email', value: 'uniworkmarket@gmail.com', href: 'mailto:uniworkmarket@gmail.com', iconColor: '#ff6584' },
  { Icon: MessageCircle, label: 'WhatsApp', value: 'Consultanos por WhatsApp', href: 'https://wa.link/92v8k3', iconColor: '#25D366' },
  { Icon: MapPin, label: 'Argentina', value: 'Paraná, Argentina', href: '#', iconColor: '#6c63ff' },
]

const socialLinks = [
  { label: 'Instagram', Icon: Camera, href: 'https://www.instagram.com/uniwork.arg?igsh=MWJlNXE1MWR1cWppdw%3D%3D&utm_source=qr' },
  { label: 'TikTok', Icon: Music, href: 'https://www.tiktok.com/@uniwork.arg?_r=1&_t=ZS-974vYGLMm2r' },
]
